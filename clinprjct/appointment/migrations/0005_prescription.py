...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('appointment', '0004_auto_20200523_2304'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Nurse', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Nurse_prescription',to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
