...
class Appointment(models.Model):
    ...
    #Nurse = models.ForeignKey(User, on_delete=models.CASCADE, related_name='Nurse',default=1)
...
class Prescription(models.Model):
    ...
    #Nurse = models.ForeignKey(User, on_delete=models.CASCADE, related_name='Nurse_prescription',default=1)
